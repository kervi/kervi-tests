...
if __name__ == '__main__':
    ...
    SENSOR_1 = Sensor("module_MemLoadSensor", "MEM", MemoryUseSensorDeviceDriver())
    ...
    SENSOR_1.link_to_dashboard(type="value", size=2, link_to_header=True)
    SENSOR_1.link_to_dashboard(type="chart", size=2)
